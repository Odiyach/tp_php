...
foreach ($orga as $key => $organisation )
{
    echo "Organisation: " ;
    $organisation->getNom() .$key."possède" . $organisation->getVehicule();


}
foreach ($organisation->getVehicule() as $conducteur)
{
    echo $organisation->getVehicule()->getConducteur();
    echo $organisation->getVehicule()->getMatriculation();
    echo $organisation->getVehicule()->getType();
    echo $organisation->getVehicule()->getStatut();
}
